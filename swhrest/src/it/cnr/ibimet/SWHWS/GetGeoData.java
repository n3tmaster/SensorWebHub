...
public class GetGeoData  extends Application {
    ...
    final static String COORD_COLS = "ST_X(the_geom) as coordx,ST_Y(the_geom) as coordy,";
        ...
        try {
            ...
            if(dsm.next()){
                ...
                while(dsm2.next()){
                    ...
                    for(int i=0; i<cp.getParamNumbers(); i++){
                        descrTxt = descrTxt + cp.getParam_name().get(i) + "=" + dsm2.getString(cp.getParam().get(i)) + " ";
                    }
