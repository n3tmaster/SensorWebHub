...
public class TDBManager extends DBManager implements DBInterface{
	...
	public static java.sql.Timestamp Gregorian2Timestamp(GregorianCalendar
			gregorianCalendar) {
	        return (gregorianCalendar == null ? null : new
	java.sql.Timestamp(gregorianCalendar.getTimeInMillis()));
	}
	
	public static GregorianCalendar Timestamp2Gregorian(java.sql.Timestamp timestamp) {
	...
	public void setParameterNull(int index) throws SQLException{
		this.dbPStmt.setNull(index, java.sql.Types.NULL);
	}
