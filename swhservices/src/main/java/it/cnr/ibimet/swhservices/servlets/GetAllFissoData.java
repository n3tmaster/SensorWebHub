...
import it.cnr.ibimet.swhservices.entities.TotemData;
...
public class GetAllFissoData extends HttpServlet {
	
	private static final long serialVersionUID = 1L;
	
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Vector<TotemData> questiRisultati = new Vector<TotemData>();
		...
		String userAgent =  request.getHeader("user-agent");
			...
			try {
				...
				System.out.println("DB Sync  Fisso- sono dentro");
				...
				String queryStr = "select  a.data,a.co2,a.tair,"
						+ "a.rad,a.noise,a.utc,a.o3,a.ntc,a.ds18,a.pk "
				...
				while(dsm.next()){
					...
					TotemData questoElem=new TotemData(dsm.getData(1), dsm.getDouble(3),dsm.getInteger(5),
							dsm.getDouble(4),dsm.getInteger(2),questaStazione,0,dsm.getInteger(7));
