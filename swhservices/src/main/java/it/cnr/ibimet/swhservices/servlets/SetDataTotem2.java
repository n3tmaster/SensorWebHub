...
public class SetDataTotem2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			questeBikeData.setO3(Integer.parseInt(st.nextToken()));
                        ...
                        questeBikeData.setNtc(Double.parseDouble(st.nextToken()));
                        questeBikeData.setDs18(Double.parseDouble(st.nextToken()));
