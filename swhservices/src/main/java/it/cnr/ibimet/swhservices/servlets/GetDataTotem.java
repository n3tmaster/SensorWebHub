...
public class GetDataTotem extends HttpServlet {
				...
				while(dsm.next()){
					...
					jobj.put("data", giorno + "-" +
							...
							minuto);
                                        ...
                                        jobj.put("lat", dsm.getDouble(7));
					jobj.put("long", dsm.getDouble(8));
                                        
                                        jobj.put("no2", dsm.getDouble(9));
                                        jobj.put("co", dsm.getDouble(10));
                                        jobj.put("voc", dsm.getDouble(11));
                                        jobj.put("utcstr", dsm.getDouble(12));
