 ...
 * @author lerocchi
 */
public class GetDataFromArea2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//		JSONObject jOutput= new JSONObject();
                 ...
                 //               while(dsm.next()){
                                    ...
                                    String queryStr = " select a.tair as tair,a.co2 as co2,a.rad as hum,a.utc as utc, " +
							"a.data as data,a.o3 as o3,a.ntc as ntc,a.ds18 as ds18,a.pk as pk, " +
                                                        "ST_X(b.the_geom) as x,ST_Y(b.the_geom) as y, "
                                            + "a.no2 as no2, a.co as co, a.voc as voc, a.utcstr as utcstr " +
                                                        "from dati_stazioni_fisse a, mobile_stations b " +
							"where   a.id_mobile_station =  b.id_mobile_station " +
                                                        "and b.nome=? " +
                                                        "and ST_Distance(b.the_geom, ST_SetSRID(ST_MakePoint("+longitude+","+lat+"),4326)) <= "+radius + " "+
							...
							"order by a.data asc";
                                    ...
                                    dsm2.setPreparedStatementRef(queryStr);
                                    		dsm2.setParameter(DBManager.ParameterType.DATE, result1, 2);
				dsm2.setParameter(DBManager.ParameterType.DATE,result2, 3);
                                	dsm2.setParameter(DBManager.ParameterType.STRING, questaStazione, 1);
                                    dsm2.runPreparedQuery();
                                    while(dsm2.next()){
                                        JSONObject jobj = new JSONObject();
                                    
                                        jobj.put("lat", dsm2.getDouble(11));
					jobj.put("long", dsm2.getDouble(10));
