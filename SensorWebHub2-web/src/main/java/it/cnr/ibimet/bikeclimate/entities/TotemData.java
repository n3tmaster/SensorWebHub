...
private GregorianCalendar gc;
	...
	public TotemData(GregorianCalendar gc,
			double tair,
			double noise,
			double rad,
			int co2,
	...
	public String getO3Out() {
		return o3Out;
	}
	
	public void setO3Out(String o3Out) {
		this.o3Out = o3Out;
	}

	public String getCo2Out() {
		return co2Out;
	}

	public void setCo2Out(String co2Out) {
		this.co2Out = co2Out;
	}
