...
import it.cnr.ibimet.bikeclimate.entities.SWEData;
 ...
 * @author lerocchi
 */
@ManagedBean(name="sweDataBean")
@SessionScoped
public class SWEDataBean implements Serializable {
	...
	private List<SWEData> sweDataList;
	private SWEData sweSelected;
    ...
    public List<SWEData> getSweDataList() {
        return sweDataList;
    }

    public void setSweDataList(List<SWEData> sweDataList) {
        this.sweDataList = sweDataList;
    }

    public SWEData getSweSelected() {
        return sweSelected;
    }

    public void setSweSelected(SWEData sweSelected) {
        this.sweSelected = sweSelected;
    }
	...
	@PostConstruct
	public void init(){
		System.out.println("SWEData - init");
		...
		try {
			...
			dsm = new TDBManager("jdbc/urbandb");
				...
				//giardino=idgiardini.get(0);
                        ...
                        TableSchema tSchema = new TableSchema(dsm, "dati_swe");
                        
                        System.out.println("Ecco la stazione "+ sweStationBean.getSweSelezionato1().getId_swe());
                        
                        ChartParams cp = new ChartParams(dsm, sweStationBean.getSweSelezionato1().getId_swe(), loginBean.getLingua());
			...
			dsm.setParameter(DBManager.ParameterType.INT, ""+sweStationBean.getSweSelezionato1().getId_swe(), 1);
		...
		try {
                    ...
                    System.out.println("Ecco la stazione "+sweStationBean.getSweSelezionato2().getId_swe());
                    ChartParams cp = new ChartParams(dsm, sweStationBean.getSweSelezionato2().getId_swe(), loginBean.getLingua());
			...
			dsm.setParameter(DBManager.ParameterType.INT, ""+sweStationBean.getSweSelezionato2().getId_swe(), 1);
